...
void RunAlgorithm(int graph[v][v], int src) // adjacency matrix     // Outputs all of the shortest paths from the source node to every other node.
{
    ...
    cout << endl << "Number of nodes visited:\t" << numOfNodes << endl;
    cout << "Number of edges visited:\t" << numOfEdges << endl;
...
int main()
{
    int graph[v][v] = {
        ...
        //		A	B	C	D	 E	 F	 G	 H
        /*A*/ {	0,  10, 0,  12,  0,	 0,  11, 4,  0,  10, 0,  12,  0,  0,  11, 4	 },
        /*B*/ { 0,  0,  0,	8,	 0,	 0,	 0,	 20, 0,  0,  0,	 8,	  0,  0,  0,  20 },
        /*C*/ { 0,  0,  0,  17,	 8,  0,  13, 0,  0,  0,  0,  17,  8,  0,  13, 0	 },
        /*D*/ { 0,  0,  0,  0,	 0,  16, 24, 14, 0,  0,  0,  0,	  0,  16, 24, 14 },
        /*E*/ { 0,  0,  0,  0,   0,	 8,	 0,  0,  0,  0,  0,  0,   0,  8,  0,  0	 },
        /*F*/ { 0,  0,  0,  0,   0,  0,	 18, 2,  0,  0,  0,  0,   0,  0,  18, 2	 },
        /*G*/ { 0,  0,  0,  0,   11, 0,  0,	 30, 0,  0,  0,  0,   11, 0,  0,  30 },
        /*H*/ { 0,  0,  10, 0,   5,	 0,  0,  0,  0,  0,  10, 0,   5,  0,  0,  0	 },
        /*I*/ {	0,  10, 0,  12,  0,	 0,  11, 4,  0,  10, 0,  12,  0,  0,  11, 4  },
        /*J*/ { 0,  0,  0,	8,	 0,	 0,	 0,	 20, 0,  0,  0,	 8,	  0,  0,  0,  20 },
        /*K*/ { 0,  0,  0,  17,	 8,  0,  13, 0,  0,  0,  0,  17,  8,  0,  13, 0	 },
        /*L*/ { 0,  0,  0,  0,	 0,  16, 24, 14, 0,  0,  0,  0,	  0,  16, 24, 14 },
        /*M*/ { 0,  0,  0,  0,   0,	 8,	 0,  0,  0,  0,  0,  0,   0,  8,  0,  0	},
        /*N*/ { 0,  0,  0,  0,   0,  0,	 18, 2,  0,  0,  0,  0,   0,  0,  18, 2	},
        /*O*/ { 0,  0,  0,  0,   11, 0,  0,	 30, 0,  0,  0,  0,   11, 0,  0, 30	},
        /*P*/ { 0,  0,  10, 0,   5,	 0,  0,  0,  0,  0,  10, 0,   5,  0,  0,  0	}
